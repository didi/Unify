...
import com.example.unicallback_demo.UFUniAPI;
import static com.example.unicallback_demo.uniapi.UniModel.map;
            ...
            if (impl != null) {
                ...
                channel.setMessageHandler((message, reply) -> {
                    ...
                    try {
                        ...
                        UniCallbackTestService.OnDoCallbackAction0Callback callback = new UniCallbackTestService.OnDoCallbackAction0Callback(binaryMessenger, callbackName, impl);
                        UFUniCallbackDispatcher.registerCallback(callbackName, callback);
            ...
            if (impl != null) {
                ...
                channel.setMessageHandler((message, reply) -> {
                    ...
                    try {
                        Map<String, Object> params = (Map<String, Object>) message;
                        String callbackName = (String) params.get("callback");
                        UniCallbackTestService.OnDoCallbackAction1Callback callback = new UniCallbackTestService.OnDoCallbackAction1Callback(binaryMessenger, callbackName, impl);
                        UFUniCallbackDispatcher.registerCallback(callbackName, callback);
