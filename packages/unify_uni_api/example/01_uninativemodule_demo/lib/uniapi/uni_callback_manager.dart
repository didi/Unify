...
class UniCallbackManager {
  ...
  UniCallbackManager._internal() {
    _channel = BasicMessageChannel<Object?>(
        'com.didi.flutter.uni_api.UniCallbackManager.callback_channel.ud',
    ...
    _channel.setMessageHandler((event) async {
      ...
      for (final callback in callbacks) {
            ...
            if (callback.getType() == DeviceInfoModel) {
                (callback as UniCallback<DeviceInfoModel>).onEvent(DeviceInfoModel.decode(data), disposable);
                continue;
            }
    ...
    _disposeChannel = const BasicMessageChannel<Object?>(
        'com.didi.flutter.uni_api.UniCallbackManager.callback_channel.dispose.ud',
        StandardMessageCodec());
  }
