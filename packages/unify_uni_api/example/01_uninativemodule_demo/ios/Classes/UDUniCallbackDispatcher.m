...
@implementation UDUniCallbackDispatcher
...
+ (void)init:(NSObject<FlutterBinaryMessenger>* _Nonnull)binaryMessenger {
    ...
    dispatch_once(&onceToken, ^{
        ...
        FlutterBasicMessageChannel *channel = [FlutterBasicMessageChannel messageChannelWithName:@"com.didi.flutter.uni_api.UniCallbackManager.callback_channel.dispose.ud" binaryMessenger: binaryMessenger];
